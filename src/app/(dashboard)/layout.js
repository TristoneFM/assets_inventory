...
export default function DashboardLayout({ children }) {
  ...
  const menuItems = [
    { id: 'crear-activo', text: 'Crear Activo', icon: <AddIcon />, path: '/crear-activo' },
    { id: 'buscar-activos', text: 'Buscar Activos', icon: <Search />, path: '/buscar-activos' },
    { id: 'configuration', text: 'Configuración', icon: <Settings />, path: '/configuration' },
  ];
